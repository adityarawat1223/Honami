...
module.exports = {
    cooldown: 10,
    data: new SlashCommandBuilder().setName("mute").setDescription("Mute any member you want using user provided time").addStringOption(option => option.setName("time").setDescription("Enter time Like 2s , 1d 10h").setRequired(true)).setDefaultMemberPermissions(PermissionFlagsBits.ModerateMembers).addUserOption(option => option.setName("user").setDescription("User you want to mute in server").setRequired(true)),
